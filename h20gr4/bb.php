...
<form class="C" method="POST">
 ...
 <input class="A" type="text" name="verdi" placeholder="Søk etter frilanser, adresse eller jobtittel"><br><br>
...
if (isset($_POST['sok']) and !empty($_POST['verdi'])) {
    ...
    $verdi = ($_POST['verdi']);
    $query = "SELECT * FROM frilanser WHERE fornavn LIKE '%$verdi%' OR adresse LIKE '%$verdi%' OR jobbtittel LIKE
     '%$verdi%' OR ommeg LIKE '%$verdi%'   ";
   ...
   <a href="info.php?idfrilanser=<?php echo $row["idfrilanser"]; ?>"><div class="D">
                    <p><b><?php echo $number, " - ", $row['fornavn']; ?> - </b></p>
                    <p><b> &ensp; Adresse :</b> <?php echo $row['adresse']; ?></p>
                    <p><b> &ensp;Jobbtittel :</b> <?php echo $row['jobbtittel']; ?></p>
